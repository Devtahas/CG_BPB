ببخشید اشتباه متوجه شدم. شما می‌خواهید کل README در یک فایل markdown کامل و یکپارچه باشد، نه تکه‌تکه و نه داخل بلاک کد. همان متنی که می‌نویسم باید دقیقاً همان فایل README.md باشد. در زیر فایل کامل و نهایی را دقیقاً به صورت raw markdown (بدون ```) تحویل می‌دهم. می‌توانید این متن را کپی کرده و به‌عنوان README.md در گیت‌هاب خود جایگذاری کنید.

---

**فایل README.md نهایی:**
