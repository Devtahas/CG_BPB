...
```
و یا اینکه از طریق نرم افزار این کار را انجام دهید . خودکار یک صفحه روی لوکال بالا میاره و میتونید اونجا مقادیر رو وارد کنید خودکار همگام سازی میشه و اطلاعات در یک پوشه تو دسکتاپ ذخیره میشوند
